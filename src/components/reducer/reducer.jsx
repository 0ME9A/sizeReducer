...
function Reducer(props) {
  ...
  if (props.fileToReducer === null || props.fileToReducer === undefined) {
    ...
    if (
      props.fileToReducer.type === "image/jpeg" ||
      props.fileToReducer.type === "image/jpg" ||
      props.fileToReducer.type === "image/png"
    ) {
  ...
  return (
    <div className="sections-container container">
      ...
      <section className="download-section">
        <a
          href={outputSrc}
          download="sizeReducer"
          className="img-download max btn"
        >
          Download
        </a>
      </section>
